...
const ThemeSelector = ({
    ...
    const handleDeleteClick = (theme, e) => {
        e.stopPropagation();
            ...
            {deletingTheme && (
                <div className="fixed inset-0 bg-black bg-opacity-60 z-[60] flex items-center justify-center p-4">
                    <div className="bg-white rounded-xl shadow-2xl max-w-md w-full">
                        <div className="bg-red-100 border-b-2 border-red-300 p-6 rounded-t-xl">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
                                ...
                                <p className="text-xs text-gray-500 mt-2">
                                    {deletingTheme.bands.length} bandes •{" "}
                                    {deletingTheme.bands.reduce(
                                        (sum, band) => sum + band.length,
                                        0
                                    )}{" "}
                                    segments au total
                                </p>
                            ...
                            <p className="text-sm text-red-600">
                                ⚠️ Cette action est irréversible. Toutes les
                                histoires favorites utilisant ce thème resteront
                                accessibles.
                            </p>
...
ThemeSelector.propTypes = {
    ...
    onImportTheme: PropTypes.func.isRequired,
};
